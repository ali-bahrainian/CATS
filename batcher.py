...
class Example(object):
  ...
  def __init__(self, article, abstract_sentences, vocab, hps):
    ...
    self.article_topic_vector = self.article_topic_vector[:hps.max_enc_steps]# Truncate topic vector
    self.article_topic_word_probs = self.article_topic_word_probs[:hps.max_enc_steps]# Truncate topic vector
...
class Batch(object):
  ...
  def init_encoder_seq(self, example_list, hps):
    ...
    self.enc_topicwords_batch = np.zeros((hps.batch_size, max_enc_seq_len), dtype=np.int32)
    self.enc_topicwords_probs_batch = np.zeros((hps.batch_size, max_enc_seq_len), dtype=np.int32)
